...
//		userService.addUser(new UserEntity("raj", "raj121", "raj@gmail.com", Arrays.asList("ROLE_ADMIN","ROLE_CLERK")));
//		userService.addUser(new UserEntity("ekta", "ekta121", "ekta@gmail.com", Arrays.asList("ROLE_CLERK")));
//		
		System.out.println("-------------------------------");
	}
